        ...
        >
          ...
          >
            <div className='relative rounded-3xl bg-[#0b0b0b] border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden'>
              ...
              <div className='realtive px-8 pt-14 pb-10 text-center'>
                <h1 className='inline-block mb-6 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-sm text-zinc-300'>
                ...
                <div className='flex items-center gap-4 my-10'>
                  ...
                  <span className='text-xs text-zinc-500 tracking-wide'>&#128274;&#xFE0E; &ensp; Secure Login</span>
                  <div className='h-px flex-1 bg-white/10' />
                </div>
